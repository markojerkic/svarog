...
func (suite *MassImportSuite) SetupSuite() {
...
func (suite *MassImportSuite) SetupTest() {
...
func (suite *MassImportSuite) TearDownTest() {
...
func (suite *MassImportSuite) TearDownSuite() {
	slog.Info("Tearing down suite")
	suite.BaseSuite.TearDownSuite()
}

func (suite *MassImportSuite) countNumberOfLogsInDb() int64 {
