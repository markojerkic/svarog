...
const useIsInstanceActive = (instance: string) => {
    ...
    const removeInstance = () => {
        ...
        console.log("Removing instance", instanceSearchParams, "merged", mergeInstancesMap(instanceSearchParams));
        setSearchParams({ instance: mergeInstancesMap(instanceSearchParams) });
    };

    const toggleInstance = () => {
        console.log(isActive()? "Is active, so going to remove" : "Is not active, so going to add it");
        if (isActive()) {
            removeInstance();
        } else {
            addInstance();
