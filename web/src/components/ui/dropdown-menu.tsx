...
export const DropdownMenuGroupLabel = <T extends ValidComponent = "span">(
	...
	return (
		<DropdownMenuPrimitive.GroupLabel
			as="div"
			class={cn("px-2 py-1.5 text-sm", local.class)}
			{...rest}
		/>
	);
};
...
export const DropdownMenuSubTrigger = <T extends ValidComponent = "div">(
	...
	return (
		<DropdownMenuPrimitive.SubTrigger
			class={cn(
				"flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-hidden focus:bg-accent data-expanded:bg-accent",
				local.class,
			)}
			{...rest}
		>
